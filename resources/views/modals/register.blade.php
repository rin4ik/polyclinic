        ...
        <modal name="register" height="auto" width="530px"  >
                <div class="card-body"  style="background:#fbfbfc">
                        <div class="modal-header " >
                                <h5 class="modal-title" style="text-align:center;">RO'YHATDAN OTISH</h5>
                        </div>
                        <form  @submit.prevent="register">
                          
    
                            <div class="form-group row" style="margin-bottom:30px; margin-top:30px">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Ism va Familiya') }}</label>
                            ...
                            <div class="form-group row" style="margin-top:30px;margin-bottom:30px">
                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Addresingiz') }}</label>
